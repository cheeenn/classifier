...
parser.add_argument('--celeba_image_dir', type=str, default='data/test_set2') #'data/CelebA_nocrop/images'
parser.add_argument('--attr_path', type=str, default='data/test_attr.txt')   #'data/list_attr_celeba.txt'  
