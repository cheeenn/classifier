...
class CelebA(data.Dataset):
    """Dataset class for the new dataset."""

    def __init__(self, image_dir, attr_path, selected_attrs, transform, mode):
        """Initialize and preprocess the new dataset."""
    ...
    def preprocess(self):
        """Preprocess the new attribute file."""
        ...
        for i, line in enumerate(lines):
            ...
            for attr_name in self.selected_attrs:
                ...
                value_f = int(float(value))
                #value_str = str(value_f) string is not ok except true or false
                #print("value = " ,value_str) 
                
                label.append(value_f)
            #print("label = " ,label) 
            ...
            if (i+1) < 2000:
                ...
                self.train_dataset.append([filename, label])
        #print("dataset = " , self.train_dataset)
    ...
    def __getitem__(self, index):
        ...
        #print ("label  is = " ,label)  the label here is true and false 
